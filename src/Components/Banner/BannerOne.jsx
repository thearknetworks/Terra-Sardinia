              ...
              <div className="container">
                <div className="hero-style1">
                  ...
                  <div
                    ...
                    data-ani-delay="0.6s"
                  >
                    <Link to={`/${i18n.resolvedLanguage || "en"}/stays`} className="th-btn th-icon" style={{ minWidth: "220px", display: "inline-flex", justifyContent: "center" }}>
                      Explore Stays
                    </Link>
                    <Link to={`/${i18n.resolvedLanguage || "en"}/destination`} className="th-btn style2 th-icon" style={{ minWidth: "220px", display: "inline-flex", justifyContent: "center" }}>
                      Discover the Area
                    </Link>
                  </div>
                </div>
